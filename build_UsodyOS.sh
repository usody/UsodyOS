...
prepare_app() {
  ...
  usody_dir="${ISO_PATH}/chroot/opt/usody"
  mkdir -p "${usody_dir}/hardware_metadata"
  ${SUDO} cp hardware_metadata/*.py "${usody_dir}/hardware_metadata"
  ${SUDO} cp *.py "${usody_dir}"
